...
**(a) 今日三大重點**：分析完今天所有素材（步驟 2–9）後，提煉出 **3 個總結性重點**。這**不是**新聞事實的條列，而是**經過分析後的判斷 / 洞察**——每一點回答「今天這些新聞合起來說明了什麼、對讀者關注的主題或持股意味著什麼」。每點 1–2 句，可對應到某條主題敘事或某個因子變化；每點盡量帶一個真實來源連結（見「來源連結硬規則」，找不到就不放）。
...
- {重點一：分析總結後的判斷 / 洞察，非單純新聞事實；1–2 句，盡量附來源}
- {重點二：同上}
- {重點三：同上}
...
4. 報告含「今日三大重點」「主題敘事（2–3 段）」「Watchlist 因子看板」「情緒指標」「宏觀經濟」「政治 / 地緣」「今日名詞解析」「對長期持有人的 so-what」各段
