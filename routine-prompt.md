...
`BTC-USD`（keyword 用 `Bitcoin`）, `NVDA`, `TSM`, `TSLA`, `PLTR`, `QQQ`, `VOO`
...
### 步驟 2.5 — AI 產業 / AI 基礎設施新聞（WebSearch，過去 24 小時）
...
4. 報告 markdown 涵蓋 watchlist 全部 9 個項目（7 美股 + 2 台股 ETF 衍生），且含「AI 產業 / AI 基礎設施」段
